export interface IFacturas{
    ...
    abono:                  number,
    abono_dolar:            number,
    tipos_facturas_id:      string | number,
    usuarios_id:            string | number,
    caja_id:                string | number,
    observacion?:           string,
    enc_presupuesto_id?:    string | number,
...
export interface IDetFacturas {
    ...
    precio:             number,
    precio_dolar:       number,
    descuentropro:      number,
    fecha_at?:          string,
    cantidad:           number,
    despachado:         number,
    devuelto:           boolean | number,
    seriales_id?:       string | number,
    monto_descuento:    number,
    lotes_id?:          string | number
}